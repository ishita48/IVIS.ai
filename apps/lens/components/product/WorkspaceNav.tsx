 ...
 * ─────────────────────────────────────────────────────────────────────
 * Camera and Pointer are the live demo flows; Knowledge map (Reasoning) is
 * the proof that LENS was tracking; Sources is grounding; Study tools is
 * review; Code is the Proof tier, the one tab where the verdict is
 * execution rather than a model.
 *
